export const vaultAbi = [
  ...
  { anonymous: false, inputs: [{ indexed: true, internalType: 'address', name: 'distributor', type: 'address' }], name: 'DistributorSet', type: 'event' },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'amount', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'incentiveRate', type: 'uint256' },
    ],
    name: 'IncentiveAdded',
    type: 'event',
  },
  ...
  { anonymous: false, inputs: [{ indexed: true, internalType: 'address', name: 'token', type: 'address' }], name: 'IncentiveTokenRemoved', type: 'event' },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'address', name: 'token', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'minIncentiveRate', type: 'uint256' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'address', name: 'token', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'bgtEmitted', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'amount', type: 'uint256' },
    ],
  ...
  { inputs: [], name: 'beaconDepositContract', outputs: [{ internalType: 'contract IBeaconDeposit', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
  {
    inputs: [
  ...
  { inputs: [{ internalType: 'address', name: 'recipient', type: 'address' }], name: 'exit', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  ...
  { inputs: [], name: 'getWhitelistedTokensCount', outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }], stateMutability: 'view', type: 'function' },
  {
  ...
  {
    inputs: [
      { internalType: 'address', name: '_beaconDepositContract', type: 'address' },
  ...
  { inputs: [], name: 'maxIncentiveTokensCount', outputs: [{ internalType: 'uint8', name: '', type: 'uint8' }], stateMutability: 'view', type: 'function' },
  {
    inputs: [
  ...
  { inputs: [{ internalType: 'address', name: 'token', type: 'address' }], name: 'removeIncentiveToken', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  ...
  { inputs: [{ internalType: 'address', name: '_rewardDistribution', type: 'address' }], name: 'setDistributor', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [{ internalType: 'uint8', name: '_maxIncentiveTokensCount', type: 'uint8' }],
    name: 'setMaxIncentiveTokensCount',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  { inputs: [{ internalType: 'address', name: '_operator', type: 'address' }], name: 'setOperator', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  ...
  { inputs: [], name: 'undistributedRewards', outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }], stateMutability: 'view', type: 'function' },
