export const saleAbi = [
  { inputs: [{ internalType: 'address', name: '_saleToken', type: 'address' }], stateMutability: 'nonpayable', type: 'constructor' },
  ...
  { inputs: [{ internalType: 'uint256', name: 'amount', type: 'uint256' }], name: 'buy', outputs: [], stateMutability: 'payable', type: 'function' },
  { inputs: [], name: 'cap', outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }], stateMutability: 'view', type: 'function' },
  { inputs: [], name: 'isPublicSale', outputs: [{ internalType: 'bool', name: '', type: 'bool' }], stateMutability: 'view', type: 'function' },
  { inputs: [], name: 'isSaleActive', outputs: [{ internalType: 'bool', name: '', type: 'bool' }], stateMutability: 'view', type: 'function' },
  { inputs: [], name: 'owner', outputs: [{ internalType: 'address', name: '', type: 'address' }], stateMutability: 'view', type: 'function' },
  { inputs: [], name: 'publicSale', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [
  ...
  { inputs: [{ internalType: 'uint256', name: 'amount', type: 'uint256' }], name: 'setMinDeposit', outputs: [], stateMutability: 'nonpayable', type: 'function' },
