export const incentiveDistributorAbi = [
  ...
  { anonymous: false, inputs: [{ indexed: false, internalType: 'uint64', name: 'delay', type: 'uint64' }], name: 'RewardClaimDelaySet', type: 'event' },
  {
    anonymous: false,
    inputs: [
  ...
  { inputs: [], name: 'MAX_REWARD_CLAIM_DELAY', outputs: [{ internalType: 'uint64', name: '', type: 'uint64' }], stateMutability: 'view', type: 'function' },
  ...
  },
  {
    ...
    name: 'incentiveTokensPerValidator',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  { inputs: [{ internalType: 'address', name: '_governance', type: 'address' }], name: 'initialize', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  ...
  { inputs: [], name: 'rewardClaimDelay', outputs: [{ internalType: 'uint64', name: '', type: 'uint64' }], stateMutability: 'view', type: 'function' },
  {
  ...
  { inputs: [{ internalType: 'bool', name: 'state', type: 'bool' }], name: 'setPauseState', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  { inputs: [{ internalType: 'uint64', name: '_delay', type: 'uint64' }], name: 'setRewardClaimDelay', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    ...
    inputs: [
      {
        ...
        internalType: 'struct IBGTIncentiveDistributor.Distribution[]',
        name: '_distributions',
        type: 'tuple[]',
      },
    ],
