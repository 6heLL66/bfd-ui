...
const SocialButton = ({
  ...
  return (
    ...
    >
      <div className="p-1.5 border-3" style={{ borderColor: color, color }}>
        {icon}
      </div>
...
export const Footer = () => {
  return (
    <footer className="pt-24">
      ...
      <div className="flex justify-center text-text opacity-80 pt-16 pb-8">
        Copyright © BeraFlow DAO 2025
      </div>
    </footer>
  );
};
