...
const TermsOfService = () => {
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="container mx-auto px-4 py-12 max-w-7xl">
      {/* Header */}
      <div className="mb-12">
        <h1 className="text-4xl font-bold bg-gradient-to-r from-primary-default to-secondary bg-clip-text text-transparent">Terms of Service</h1>
        <p className="text-foreground-secondary mt-2">Please read these terms carefully before using our service</p>
      </div>
      ...
      <Card className="relative overflow-hidden bg-surface/30 backdrop-blur-sm border-2 border-border/40 hover:border-border transition-all duration-300">
        ...
        <div className="relative p-8 space-y-8 text-foreground-secondary">
          ...
          <section>
            ...
            <div className="space-y-4">
              <p className="leading-relaxed">The materials and services on this website are provided on an `as is`` basis. You acknowledge that:</p>
              <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            ...
            <p className="leading-relaxed">
              We may revise these terms of service at any time without notice. Changes may be implemented through governance proposals. By continuing to use this website and our
          ...
          <section>
            ...
            <p className="leading-relaxed">
              These terms and conditions are governed by and construed in accordance with applicable laws, and any disputes relating to these terms and conditions will be subject
          ...
          <div className="mt-12 pt-8 border-t-2 border-border/40">
            <div className="flex flex-col gap-4">
              ...
              <div className="flex gap-4 text-sm">
                ...
                <Link href="/privacy-notice" className="text-primary-default hover:text-primary-hover transition-colors">
                  Privacy Policy
                </Link>
              </div>
            </div>
