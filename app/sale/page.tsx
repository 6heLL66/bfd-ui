        ...
        <div className="flex flex-col gap-8 w-full">
          <div className="flex items-center justify-between border-b-2 border-border/40 pb-6">
            <div className="space-y-1">
              <span className="text-h3 font-bold bg-gradient-to-r from-primary-default via-primary-hover to-secondary bg-clip-text text-transparent">
                Supply USDC
              </span>
          ...
          <div className="grid grid-cols-2 gap-8">
            <div className="space-y-4">
              ...
              >
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="font-bold text-lg text-foreground-primary">1.00 USDC</span>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="font-bold text-lg text-foreground-primary">1,000,000 USDC</span>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="font-bold text-lg text-foreground-primary">0 USDC</span>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center justify-between gap-2">
                  <span className="text-sm text-foreground-secondary">Your allocation</span>
                  <span className="font-bold text-lg text-foreground-primary">1,000 USDC</span>
                </div>
              </motion.div>
            </div>
            ...
            <div className="flex flex-col justify-center gap-6">
              <div className="space-y-3">
                ...
                <Input 
                  variant="faded" 
                  className="dark w-full backdrop-blur-sm bg-surface border-2 border-border/40 focus:border-primary-default/60"
                  placeholder="Enter USDC amount"
                  endContent={
                    <div className="flex items-center">
                      <Divider className="h-8 mx-4 bg-border/40" orientation="vertical" />
                      <span className="text-foreground-secondary font-medium">USDC</span>
                    </div>
                  }
                />
                <p className="text-xs text-foreground-secondary">Available balance: 2,500 USDC</p>
              </div>
              <Button 
